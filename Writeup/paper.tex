...
%TODO (Jacques) I think it might be good to analyse the WHOIS organisation for Twitch and Soundcloud. Is the same organisation serving up the content for each ISP? Who is serving up the content for these two services?
...
% Can you expand the above statement. What is less than 100ms? Because twitch and soundcloud is always in EU > 100ms.
...
\begin{table}
	\centering
	\caption{Hop count using UCT network}
...
\begin{table}
	\centering
	\caption{Throughput using UCT network}
